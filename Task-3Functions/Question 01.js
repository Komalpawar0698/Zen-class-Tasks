...
we call this function => var array=[1,2,3,4,5,5,6,7,8,9,];
...
anonymous:
var string="My Name is Kavya";
function(str){
    str =str.toLowerCase().split(' ');
    for (var i=0; i<str.length;i++){
        str[i].charAt(0).toUpperCase() +str[i].slicce(10);
    }
    return str.join(' ');
}(str)

we can all this function=>
var str="My Name is Kavya";
